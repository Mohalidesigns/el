...
<div class="container">
  <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
    ...
    <h3 style="font-size: 20px;">Factory Project Upload</h3>
    <form action="{{ url('fproject') }}" class="form-image-upload" method="POST" enctype="multipart/form-data">
    ...
    <div class='list-group gallery'>
            ...
            @if($images->count())
                ...
                <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>
                    <a class="thumbnail fancybox" rel="ligthbox" href="/factory/{{ $image->image }}">
                        <img class="img-responsive" alt="" src="/factory/{{ $image->image }}" />
                        <div class='text-center'>
                            <small class='text-muted'><h3>{{ $image->title }}</h3></small>
                        </div> <!-- text-center / end -->
                    </a>
                    <form action="{{ url('fproject',$image->id) }}" method="POST">
