...
<li>
<a href="http://paul-themes.com/html/go-arch/demo/dark/index.html">Home - Dark</a>
</li>
</ul>
</li>
<li>
...
<img alt="" width="46" src="{{asset('img/img-icon/icon-architecture.png')}}">
<h4>Architecture</h4>
</div>
<div class="service-item">
<img alt="" width="58" src="{{asset('img/img-icon/icon-interiors.png')}}">
<h4>Interiors</h4>
</div>
<div class="service-item">
<img alt="" width="58" src="{{asset('img/img-icon/icon-planing.png')}}">
<h4>Planing</h4>
</div>
</div>
...
<a href="{{asset('img/projects/1-480x880.jpg')}}" title="project 1">
<figure>
...
<div class="project project-light">
<a href="{{asset('img/projects/2-480x880.jpg')}}" title="project 2">
<figure>
...
<div class="project">
<a href="{{asset('img/projects/3-480x880.jpg')}}" title="project 3">
<figure>
...
<div class="project">
<a href="{{asset('img/projects/4-480x880.jpg')}}" title="project 4">
<figure>
...
<div class="project">
<a href="{{asset('img/projects/5-480x880.jpg')}}" title="project 5">
<figure>
...
<div class="project">
<a href="{{asset('img/projects/6-480x880.jpg')}}" title="project 6">
<figure>
...
<div class="project">
<a href="{{asset('img/projects/7-480x880.jpg')}}" title="project 7">
<figure>
<img alt="" src="{{asset('img/projects/7-480x880.jpg')}}">
<figcaption>
<h3 class="project-title">
Residential care<br> project in Paris
</h3>
...
<div class="project">
<a href="{{asset('img/projects/8-480x880.jpg')}}" title="project 8">
<figure>
<img alt="" src="{{asset('img/projects/8-480x880.jpg')}}">
<figcaption>
<h3 class="project-title">
Residential care<br> project in Paris
</h3>
...
<li class="client">
<a href="#"><img alt="" src="{{asset('img/clients/1.png')}}"></a>
</li>
<li class="client">
<a href="#"><img alt="" src="{{asset('img/clients/2.png')}}"></a>
</li>
<li class="client">
<a href="#"><img alt="" src="{{asset('img/clients/3.png')}}"></a>
</li>
<li class="client">
<a href="#"><img alt="" src="{{asset('img/clients/4.png')}}"></a>
</li>
<li class="client">
<a href="#"><img alt="" src="{{asset('img/clients/5.png')}}"></a>
</li>
<li class="client">
<a href="#"><img alt="" src="{{asset('img/clients/1.png')}}"></a>
</li>
...
+7 (212) 654-33-35<br>
+7 (212) 287-85-22<br>
<a href="http://paul-themes.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="2c45424a436c4b434d5e4f44024f4341">[email&#160;protected]</a><br>
